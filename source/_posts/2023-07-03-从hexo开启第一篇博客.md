...
找到你的地域节点，点击你的bucket名，然后点击bucket下的概览，在访问端口一栏找到你的地域节点，后面会用到

如图，只需要复制`oss-cn-shanghai`即可，不需要后面的`.aliyuncs.com`
...
Picgo启动后，在任务栏里找到picgo的图标，打开picgo的主界面，在图床设置里面选择阿里云OSS，依照以下步骤填写信息：
...
进入typora主界面，点击左上角的“文件-偏好设置”，选择图像，选择插入图片时上传图片
...
<img src="https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202307241617954.png" style="zoom: 50%;" />点击验证图片上传选项，提示成功就大功告成辣！
